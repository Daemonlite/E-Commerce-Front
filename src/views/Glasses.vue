...
const products = ref([
  ...
  },
  {
    ...
    category: 'Casual',
    gender: 'Women',
    image: 'https://images.unsplash.com/photo-1508296695146-257a814070b4?q=80&w=1780&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
  },
  {
    id: 8,
    name: 'Blaze Burst',
    ...
    category: 'Sport',
    gender: 'Men',
    image: 'https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8c3VuZ2xhc3Nlc3xlbnwwfHwwfHx8MA%3D%3D'
  }
]);
...
<template>
  <div class="font-[sans-serif] bg-gray-100">
    <div class="p-4 mx-auto lg:max-w-7xl sm:max-w-full">
      <h2 class="text-4xl font-extrabold text-gray-800 mb-6"></h2>
      <div class="flex justify-center mb-4">

        <div class="bg-white flex px-1 py-1 rounded-full border border-blue-500 overflow-hidden  mx-auto font-[sans-serif] w-">
        <input type='email' placeholder='Search Something...' class="w-[100rem] outline-none bg-white pl-4 text-sm" />
        <button type='button'
