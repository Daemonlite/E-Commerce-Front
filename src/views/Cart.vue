            ...
            <div class="grid lg:grid-cols-2 gap-12">
                    ...
                    <div class="bg-gray-100 p-6 rounded-md">
                        ...
                        <div class="space-y-4 mt-8">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="w-full">
                                    <h3 class="text-base font-semibold text-gray-800">Velvet Sneaker</h3>
                                    <h6 class="text-sm text-gray-800 font-bold cursor-pointer mt-0.5">$18.00</h6>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="w-full">
                                    <h3 class="text-base font-semibold text-gray-800">Smart Watch Timex</h3>
                                    <h6 class="text-sm text-gray-800 font-bold cursor-pointer mt-0.5">$90.00</h6>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="w-full">
                                    <h3 class="text-base font-semibold text-gray-800">Sun Glass</h3>
                                    <h6 class="text-sm text-gray-800 font-bold cursor-pointer mt-0.5">$30.00</h6>
                ...
                <form>
                    ...
                    <div class="grid gap-4 mt-8">
                        <div>
                            <label class="block text-base font-semibold text-gray-800 mb-2">Card Holder Name</label>
                        ...
                        <div>
                            <label class="block text-base font-semibold text-gray-800 mb-2">Card Number</label>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-base font-semibold text-gray-800 mb-2">Expiry Date</label>
                                <input type="number" placeholder="08/27"
                                    class="px-4 py-3 bg-transparent text-gray-800 w-full text-sm border border-gray-300 rounded-md focus:border-purple-500 outline-none" />
                            </div>

                            <div>
                                <label class="block text-base font-semibold text-gray-800 mb-2">CVV</label>
                    ...
                    <ul class="text-gray-800 mt-8 space-y-4">
                        <li class="flex flex-wrap gap-4 text-sm">Subtotal <span class="ml-auto font-bold">$138.00</span></li>
                        ...
                        <hr class="border-gray-300" />
                        <li class="flex flex-wrap gap-4 text-sm font-bold">Total <span class="ml-auto">$142.00</span></li>
                    </ul>

                    <button type="button" class="mt-8 text-sm px-4 py-3 w-full font-semibold tracking-wide bg-purple-600 hover:bg-purple-700 text-white rounded-md">Make Payment  </button>
                </form>
            </div>
        </div>
</template>