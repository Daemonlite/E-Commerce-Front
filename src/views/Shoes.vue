  ...
  <div class="font-[sans-serif] bg-gray-100">
    <div class="p-4 mx-auto lg:max-w-7xl sm:max-w-full">
      ...
      <div class="flex justify-center mb-4">
        <div
          class="bg-white flex px-1 py-1 rounded-full border border-blue-500 overflow-hidden mx-auto font-[sans-serif] w-"
        >
          <input
            type="email"
            placeholder="Search Something..."
            class="w-[100rem] outline-none bg-white pl-4 text-sm"
          />
          <button
            type="button"
      ...
      >
        ...
        >
          ...
          <div>
            <h3
              class="text-lg font-extrabold text-gray-800 cursor-pointer"
            ...
            <div
              ...
              class="bg-gray-200 w-10 h-10 flex items-center justify-center rounded-full cursor-pointer absolute bottom-4 right-4"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="fill-gray-800 w-6 h-6"
                viewBox="0 0 24 24"
              >
                <path
