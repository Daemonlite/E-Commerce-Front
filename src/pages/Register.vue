...
<template>
    <div class="font-[sans-serif] bg-gray-50 flex items-center md:h-screen p-4">
      <div class="w-full max-w-5xl max-md:max-w-xl mx-auto">
        <div class="bg-white grid md:grid-cols-2 gap-16 w-full sm:p-8 p-6 shadow-md rounded-md overflow-hidden">
          ...
          <form class="w-full">
            ...
            <p class="text-gray-800 text-sm mt-6 text-center">Already have an account? <router-link :to="{ name: 'login' }" class="text-blue-600 font-semibold hover:underline ml-1">Login here</router-link></p>
          </form>
        </div>
      </div>
    </div>
