...
<template>
    <div class="font-[sans-serif] bg-white flex items-center justify-center md:h-screen p-4 mt-5">
      <div class="shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)] max-w-6xl max-md:max-w-lg rounded-md p-6">
        ...
        <div class="grid md:grid-cols-2 items-center gap-8">
          ...
          <form class="md:max-w-md w-full mx-auto">
            ...
            <div class="mt-12">
              <button type="button" class="w-full shadow-xl py-2.5 px-5 text-sm font-semibold rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">
                Sign in
              </button>
              <p class="text-gray-800 text-sm text-center mt-6">Don't have an account <router-link :to="{ name: 'register' }" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</router-link></p>
            </div>
          </form>
        </div>
      </div>
